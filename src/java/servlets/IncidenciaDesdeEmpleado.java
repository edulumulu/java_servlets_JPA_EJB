 ...
 * @author edulumulu
 */
@WebServlet(name = "IncidenciaDesdeEmpleado", urlPatterns = {"/IncidenciaDesdeEmpleado"})
public class IncidenciaDesdeEmpleado extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            //out.println("<h1>Servlet IncidenciaDesdeEmpleado at " + request.getContextPath() + "</h1>");
            ...
            try {
                ...
                if (emp != null) {
                    ...
                    List<Incidencias> lista_incidencias = iEJB.findIncidenciaOriginadaByEmpleado(emp);

                    if (lista_incidencias.isEmpty()) {
                        out.println("<p>No hay incidencias originadas por este usuario.</p>");
                    } else {
                        out.println("<h1>Incidencias originadas por: " + emp.getNombreCompleto() + " --> id: " + emp.getIdEmpleado() + "</h1>");
                        out.println("<table>");
                        out.println("<tr>");
            ...
            out.println("<form action=\"IncidenciaDesdeEmpleado.html\" method=\"POST\">"
