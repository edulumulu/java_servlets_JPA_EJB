...
public class ModificarContrasena extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ModificarContrasena</title>");
            out.println("<link rel=\"stylesheet\" type=\"text/css\" href=\"css/estilos.css\">");
            out.println("</head>");
            out.println("<body>");
            //out.println("<h1>Servlet ModificarContrasena at " + request.getContextPath() + "</h1>");
            ...
            if (id.equalsIgnoreCase("") || pass.equalsIgnoreCase("")) {
                ...
                try {
                    ...
                    if (empleado == null) {
                        ...
                        Empleados em = new Empleados(id_int, pass);
                        if (iEJB.updateContrasena(em, pass)) {
                            out.println("Contraseña modificada.");
                        } else {
                            out.println("No se ha podido modificar la contraseña porque ese id de empleado no exite.");
                        }
                    }
